...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ABSiteBundle', ($this->targetDirs[2].'/Resources/ABSiteBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ABSiteBundle', ($this->targetDirs[3].'\\src\\AB\\SiteBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', ($this->targetDirs[2].'/Resources/AcmeDemoBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', ($this->targetDirs[3].'\\src\\Acme\\DemoBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sitenew', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\AB\\SiteBundle\\Entity'))), 'AB\\SiteBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ABSiteBundle' => 'AB\\SiteBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_96367f921e57ba799a226fab75dc653d19ee098edd70f2289498457b94bc46ea');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('a.boixel@gmail.com');
        $a->setPassword('Alicemadness23');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin('a.boixel@gmail.com', array());
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AB\\SiteBundle/Resources/views'), 'ABSite');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('958ef866272e1c3ccfb5f5b10c51ce4662391931');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ABSiteBundle' => 'AB\\SiteBundle\\ABSiteBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'sitenew',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'localhost',
            'mailer_user' => 'a.boixel@gmail.com',
            'mailer_password' => 'Alicemadness23',
            'locale' => 'en',
            'secret' => '958ef866272e1c3ccfb5f5b10c51ce4662391931',
            'database_path' => NULL,
            ...
            'kernel.secret' => '958ef866272e1c3ccfb5f5b10c51ce4662391931',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'a.boixel@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Alicemadness23',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.mailer.default.spool.enabled' => false,
            'swiftmailer.mailer.default.plugin.impersonate' => NULL,
            'swiftmailer.mailer.default.single_address' => 'a.boixel@gmail.com',
            'swiftmailer.mailer.default.delivery_whitelist' => array(

            ),
            'swiftmailer.spool.enabled' => false,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'a.boixel@gmail.com',
